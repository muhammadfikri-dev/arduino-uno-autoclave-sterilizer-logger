/**
 * =========================================================================================
 * Project     : Arduino Uno Dental Autoclave Steam Sterilizer Validation Logger
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Sterilization validation system monitoring saturated steam temperature (134°C) and pressure (2.1 bar), verifying F0 lethality kill time, and logging to SD card.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Dental Autoclave Steam Sterilizer Validation Logger"));
