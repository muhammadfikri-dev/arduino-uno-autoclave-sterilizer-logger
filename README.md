# ⚡ Arduino Uno Dental Autoclave Steam Sterilizer Validation Logger
...
Sterilization validation system monitoring saturated steam temperature (134°C) and pressure (2.1 bar), verifying F0 lethality kill time, and logging to SD card.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-autoclave-sterilizer-logger.ino`](./arduino-uno-autoclave-sterilizer-logger.ino).
